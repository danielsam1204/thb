...
class GoogleMapResponse {
  ...
  GoogleMapResponse({this.results, this.status});

  GoogleMapResponse.fromJson(Map<String, dynamic> json) {
    if (json['results'] != null) {
      results = <MapData>[];
      json['results'].forEach((v) {
        results!.add(MapData.fromJson(v));
      });
    }
    status = json['status'];
  }
...
class MapData {
  ...
  MapData.fromJson(Map<String, dynamic> json) {
    ...
    plusCode = json['plus_code'] != null
        ...
        : null;
    rating = json['rating'] != null && json['rating'] is int
...
class Photos {
  ...
  Photos.fromJson(Map<String, dynamic> json) {
    ...
    photoReference =
        "https://maps.googleapis.com/maps/api/place/photo?maxwidth=1000&photo_reference=${json['photo_reference']}&key=${AppConstant.mapApiKey}";
    width = json['width'];
  }
